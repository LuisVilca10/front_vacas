...
class FincaFormEdit extends StatefulWidget {
  ...
  FincaFormEdit({required this.modelFA}) : super();

  @override
  _FincaFormEditState createState() => _FincaFormEditState(modelFA: modelFA);
  //const FincaForm({super.key});
}

class _FincaFormEditState extends State<FincaFormEdit> {
  FincaModelo modelFA;
  _FincaFormEditState({required this.modelFA}) : super();
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _buildDatoNombreFinca(capturaNombreFinca,
                          modelFA.nombreFinca, "Nombre Finca:"),
                      SizedBox(
                        height: 15,
                      ),
                      _buildDatoNumber(
                          capturaArea, modelFA.are, "Area total Finca"),
                      SizedBox(
                        height: 15,
                      ),
                      Row(
                        children: [
                          ...
                          Flexible(
                            child: _buildDatoPhone(
                                capturaTelefono, modelFA.telefono, "Celular:"),
                          ),
                        ],
                      ),
                      SizedBox(
  ...
  Widget _buildDatoUsuario(Function obtValor, String label) {
    return TextFormField(
  ...
  Widget _buildDatoNombreFinca(Function obtValor, String _dato, String label) {
    return TextFormField(
      decoration: InputDecoration(
        labelText: label,
        border: OutlineInputBorder(
