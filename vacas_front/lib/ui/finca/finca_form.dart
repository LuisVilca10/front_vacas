...
class _FincaFormState extends State<FincaForm> {
  ...
  late String _proposito = "PL";
  late String _meleche = "B";
  late String _usario = "1";
  ...
  List<Map<String, String>> listaUser = [
    {'value': '1', 'display': 'Juan.Perez'},
    {'value': '2', 'display': 'Orazzcio.Gaspar'},
    {'value': '3', 'display': 'Inavilitado'},
    {'value': '4', 'display': 'adffasdf'}
  ];
  List<Map<String, String>> listapro = [
    {'value': 'PL', 'display': 'Producción Leche'},
    {'value': 'PC', 'display': 'Producci+on Carne'},
  ];
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _buildDatoLista(
                          capturaUsuario, _usario, "Usuario:", listaUser),
                      SizedBox(
                        height: 15,
                      ),
